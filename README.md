...
- **Teacher model (synthetic labeler):** local **72B/70B** on the GH200 (`Qwen2.5-72B` or `Llama-3.3-70B`)
  via vLLM fp8. Free at scale, keeps PII on-box.
...
```bash
bash serve/serve_teacher.sh Qwen/Qwen2.5-72B-Instruct        # port 8001
# in another shell:
